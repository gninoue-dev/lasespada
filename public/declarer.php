...
<form id="rendered-form">
  <div class="rendered-form">
    ...
    <div class="formbuilder-number form-group field-txt_postalcode">
      ...
      <input type="file" placeholder="Explique vous ici....." class="form-control" name="txt_postalcode" id="txt_postalcode" required >
    </div>
    ...
    <div class="formbuilder-button form-group field-btn_submit">
      <button type="submit" class="btn-default btn btn_submit" name="btn_submit" value="true"id="btn_submit">Declarer</button>
    </div>
  </div>
</form>
